...
var doTheMagic = function doTheMagic() {
...
var contrastColor = function getContrastColor(hexcolor){
  ...
  var affector = ( (r*299) + (g*587) + (b*114) ) / 1000;
  return (affector >= 128) ? 'black' : 'white';
}
